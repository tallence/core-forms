 ...
 */
class UsersMailSerializer extends AbstractFormElementSerializer<UsersMail> {

  UsersMailSerializer(BiFunction<String, Object[], String> messageResolver, ValidationSerializationHelper validationSerializationHelper) {
    super(UsersMail.class, messageResolver, validationSerializationHelper);
  }
