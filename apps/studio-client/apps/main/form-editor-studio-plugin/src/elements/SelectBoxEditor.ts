...
import Icon from "../icons/select-dropdown.svg";
import AbstractFormElement from "./AbstractFormElement";

interface SelectBoxEditorConfig extends Config<AbstractFormElement> {
}

class SelectBoxEditor extends AbstractFormElement {
  declare Config: SelectBoxEditorConfig;

  static override readonly xtype: string = "com.tallence.formeditor.studio.elements.selectBoxEditor";

  static readonly FIELD_TYPE: string = "SelectBox";

  constructor(config: Config<SelectBoxEditor> = null) {
    super(ConfigUtils.apply(Config(SelectBoxEditor, {
      formElementType: SelectBoxEditor.FIELD_TYPE,
